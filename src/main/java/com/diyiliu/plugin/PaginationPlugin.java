...
public class PaginationPlugin implements Interceptor {
    ...
    public StringBuilder buildPageSqlForMysql(String sql, int currentPage, int pageSize) {
        ...
        pageSql.append(" limit " + currentPage * pageSize + "," + pageSize);
        return pageSql;
    }
    ...
    public StringBuilder buildPageSqlForOracle(String sql, int currentPage, int pageSize) {
        ...
        pageSql.append(sql);
        pageSql.append(" ) temp where rownum <= ").append((currentPage + 1) * pageSize);
        pageSql.append(") where row_id > ").append(currentPage * pageSize);
        return pageSql;
    }
